...
<html>
	...
	<body>
		...
		<div class="titre">
			<h1><marquee scrollamount="5" width="40">&lt;&lt;&lt;</marquee> Mode <marquee scrollamount="5" direction="right" width="40">&gt;&gt;&gt;</marquee></h1>
		</div>
		...
		<div class="milieu">
			<?php 
				try {
					...
					$reponse = $bdd->query('SELECT * FROM produit, categorie WHERE categorie = 3 and categorie_id = 3'); // Envoi dee la requ�te
					echo '<table>
							<tr>

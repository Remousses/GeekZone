...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 22 Mai 2017 à 19:12
...
CREATE TABLE `administrateur` (
  ...
  `gestions` varchar(20) NOT NULL DEFAULT 'produits'
...
INSERT INTO `administrateur` (`id`, `nom`, `prenom`, `login`, `mdp`, `gestions`) VALUES
(1, 'Argentin', 'Rémy', 'rargentin', '123456', 'produits'),
(2, 'Blanchet', 'Antoine', 'ablanchet', '123456', 'boutiques'),
(3, 'Novais', 'Alexandre', 'anovais', '123456', '');
...
(1, 'Glaçons Tetris', 'Plongez ces glaçons Tetris dans votre verre et ceux de vos amis pour recréer des parties interminables ! Un élément geek indispensable pour passer une bonne soirée à se remémorer les jeux de votre enfance ! Regardez les glaçons s\'imbriquer les uns sur les autres tout en buvant votre breuvage bien frais.', 'LICENCE OFFICIELLE TETRIS&lt;br/&gt;Recréez une partie de Tetris mais cette fois-ci dans votre verre avec ces glaçons Tetris !&lt;br/&gt;Sous licence officielle, ces glaçons emblématiques sont les véritables glaçons à forme de blocs Tetris : les Tetrimono !&lt;br/&gt;Plongez-les dans les verres de vos amis pour les ramener au bon vieux temps des jeux d\'arcade !&lt;br/&gt;&lt;br/&gt;Caractéristiques :&lt;br/&gt;* Bac à glaçons en plastique mou, il reste souple même quand les glaçons sont gelés afin que votre glaçon en forme de tetrimono soit toujours facile à enlever.', 8.9, 'glacons-tetris.jpg', 1),
